    ...
    <div className="container my-posts-page" style={{ padding: 16 }}>
      ...
      <ul className="myposts-list" style={{ listStyle: "none", padding: 0, margin: 0 }}>
        {items.map((p) => (
          ...
          >
            <header className="post-card__header" style={{ marginBottom: 8 }}>
              <div className="post-card__title" style={{ fontWeight: 700, fontSize: 18 }}>
            ...
            <div className="post-card__footer" style={{ marginTop: 12 }}>
              <Link className="btn btn-outline" to={`/post/edit/${p.id}`}>
                Edit
              </Link>
            </div>
          </li>
