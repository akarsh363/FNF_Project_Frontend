...
//   useEffect(()=>{(async()=>{
//     try{ const p = await getMyPosts(); setPosts(Array.isArray(p)?p:[]); }
//     catch{ navigate("/login", { replace:true }); }
//   })();},[navigate]);

//   if (posts===null) return <div className="loading">Loading...</div>;
//   if (posts.length===0) return <div className="no-posts">You don’t have any posts yet.</div>;
...
//                 {/* Employees can't delete their own posts */}
//               </div>
//             </div>
//           </li>
//         ))}
